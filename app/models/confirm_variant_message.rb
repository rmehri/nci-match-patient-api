class ConfirmVariantMessage
  ...
  def self.from_url(url_segments)
    ...
    raise ActionController::BadRequest.new("Unregnized checked flag in variant confirmation url") unless (url_segments.include?("unchecked") || url_segments.include?("checked"))
