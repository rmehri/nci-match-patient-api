module VariantReportHelper
  ...
  def self.add_download_links(variant_report)
    ...
    variant_report[:dna_bai_path_name] = find_file_link(files, variant_report[:dna_bai_name]) unless variant_report[:dna_bai_name].blank?
    ...
    variant_report[:rna_bam_path_name] = find_file_link(files, variant_report[:rna_bai_name]) unless variant_report[:rna_bai_name].blank?
    variant_report[:rna_bai_path_name] = find_file_link(files, variant_report[:rna_bam_name]) unless variant_report[:rna_bam_name].blank?
