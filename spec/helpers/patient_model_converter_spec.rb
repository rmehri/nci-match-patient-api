  ...
  let(:variant_report_db_model_list) do
    [1,2].map { |i|
      NciMatchPatientModels::VariantReport.new(
          ...
          :s3_bucket          => "my_bucket",
          :dna_bam_path_name => "http:\\\\blah.com\\dna_bam.data",
          :dna_bai_path_name => "http:\\\\blah.com\\dna_bai.data",
          :rna_bam_path_name => "http:\\\\blah.com\\rna_bam.data",
          :rna_bai_path_name => "http:\\\\blah.com\\rna_bai.data",
          :vcf_path_name          => "http:\\\\blah.com\\vcf.data",
          :total_variants         => "8",
          :cellularity            => "7",
          :total_mois             => "4",
          :total_amois            => "2",
