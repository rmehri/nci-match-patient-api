...
describe V1::HealthChecksController do
  describe 'GET #HealthCheck' do
    ...
    it 'Should return the Connection Details' do
      ...
      expect(response.body).to eq({ 'dynamodb_connection' => 'successfull', 'queue_name' => 'patient_queue', 'queue_connection' => 'successfull' }.to_json)
    end
    ...
    it 'should handle errors properly' do
      ...
      get :health_check
      expect(response.body).to eq({ 'dynamodb_connection' => nil, 'queue_name' => 'patient_queue', 'queue_connection' => 'successfull' }.to_json)
   end
  end
end
